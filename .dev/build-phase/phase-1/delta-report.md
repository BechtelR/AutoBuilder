...
| ERRATA.md #1 (state writes) | spec.md Research Notes "State Access in CustomAgent" (lines 389-398) documents "Write (direct)" as a valid pattern, contradicting Decision D9 (design-changelog.md, line 39) which was **REVISED** to say direct writes do NOT persist. | spec.md Research Notes | Mark "Write (direct)" as deprecated with note. |
